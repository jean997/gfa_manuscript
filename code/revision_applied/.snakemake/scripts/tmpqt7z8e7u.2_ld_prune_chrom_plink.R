...
snakemake <- Snakemake(
    input = list('../../data/gfa_intermediate_data/bc_zmat.14.RDS', '/nfs/turbo/sph-jvmorr/ld_reference_files/1kg_plink/EUR.bed', "zmat" = '../../data/gfa_intermediate_data/bc_zmat.14.RDS', "bfile" = '/nfs/turbo/sph-jvmorr/ld_reference_files/1kg_plink/EUR.bed'),
    output = list('../../data/gfa_intermediate_data/bc_zmat.ldpruned_r20.01_kb1000_pvalue_jitter0.5_2.14.RDS', "out" = '../../data/gfa_intermediate_data/bc_zmat.ldpruned_r20.01_kb1000_pvalue_jitter0.5_2.14.RDS'),
    ...
    wildcards = list('bc', '0.01', '1000', 'pvalue', '0.5', '2', '14', "prefix" = 'bc', "r2_thresh" = '0.01', "kb" = '1000', "p" = 'pvalue', "jitter_sd" = '0.5', "jitter_seed" = '2', "chrom" = '14'),
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'mem_mib', 'disk_mb', 'disk_mib', 'tmpdir', "mem_mb" = 2345, "mem_mib" = 2237, "disk_mb" = 2345, "disk_mib" = 2237, "tmpdir" = '/tmp'),

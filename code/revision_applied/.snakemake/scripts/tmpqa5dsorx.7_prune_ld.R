...
snakemake <- Snakemake(
    input = list('../../results/gfa_results/bc_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_none.3.RDS', "Z" = '../../results/gfa_results/bc_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_none.3.RDS'),
    output = list('../../results/gfa_results/bc_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_none.top_snps.3.RDS', "out" = '../../results/gfa_results/bc_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_none.top_snps.3.RDS'),

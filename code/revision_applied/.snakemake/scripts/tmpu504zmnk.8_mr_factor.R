...
snakemake <- Snakemake(
    ...
    wildcards = list('bc', 'van-der-Harst_2017_29212778__CAD', 'gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc', "prefix" = 'bc', "outcome" = 'van-der-Harst_2017_29212778__CAD', "analysis" = 'gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc'),
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'mem_mib', 'disk_mb', 'disk_mib', 'tmpdir', "mem_mb" = 3400, "mem_mib" = 3243, "disk_mb" = 3400, "disk_mib" = 3243, "tmpdir" = '/tmp'),

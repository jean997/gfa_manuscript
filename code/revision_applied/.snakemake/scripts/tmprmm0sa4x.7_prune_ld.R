...
snakemake <- Snakemake(
    input = list('../../results/applied_analysis/gfa_results/bc_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_none.5.RDS', "Z" = '../../results/applied_analysis/gfa_results/bc_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_none.5.RDS'),
    output = list('../../results/applied_analysis/gfa_results/bc_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_none.top_snps.5.RDS', "out" = '../../results/applied_analysis/gfa_results/bc_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_none.top_snps.5.RDS'),
    ...
    wildcards = list('bc', 'gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_none', '5', "prefix" = 'bc', "analysis" = 'gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_none', "chrom" = '5'),
    threads = 1,
    log = list(),

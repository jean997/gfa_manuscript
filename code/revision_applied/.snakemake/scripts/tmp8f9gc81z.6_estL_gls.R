...
snakemake <- Snakemake(
    input = list('../../data/gfa_intermediate_data/bc_zmat.13.RDS', '../../results/applied_analysis/gfa_results/bc_gfa_gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_none.final.RDS', '../../data/gfa_intermediate_data/bc_R_estimate.R_none.RDS', "z_file" = '../../data/gfa_intermediate_data/bc_zmat.13.RDS', "gfa_file" = '../../results/applied_analysis/gfa_results/bc_gfa_gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_none.final.RDS', "R" = '../../data/gfa_intermediate_data/bc_R_estimate.R_none.RDS'),
    output = list('../../results/applied_analysis/gfa_results/bc_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_none.13.RDS', "out" = '../../results/applied_analysis/gfa_results/bc_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_none.13.RDS'),
    params = list(),
    wildcards = list('bc', '1', 'r20.01_kb1000_pvalue', 'none', '13', "prefix" = 'bc', "fs" = '1', "ldstring" = 'r20.01_kb1000_pvalue', "Rstring" = 'none', "chrom" = '13'),
    threads = 1,
    log = list(),

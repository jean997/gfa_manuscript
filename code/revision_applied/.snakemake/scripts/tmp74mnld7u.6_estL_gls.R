...
snakemake <- Snakemake(
    input = list('../../data/gfa_intermediate_data/metab_zmat.19.RDS', '../../results/applied_analysis/gfa_results/metab_gfa_gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_pt0.05.final.RDS', '../../data/gfa_intermediate_data/metab_R_estimate.ldpruned_r20.01_kb1000_pvalue.R_pt0.05.RDS', "z_file" = '../../data/gfa_intermediate_data/metab_zmat.19.RDS', "gfa_file" = '../../results/applied_analysis/gfa_results/metab_gfa_gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_pt0.05.final.RDS', "R" = '../../data/gfa_intermediate_data/metab_R_estimate.ldpruned_r20.01_kb1000_pvalue.R_pt0.05.RDS'),
    output = list('../../results/applied_analysis/gfa_results/metab_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_pt0.05.19.RDS', "out" = '../../results/applied_analysis/gfa_results/metab_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_pt0.05.19.RDS'),
    params = list(),
    wildcards = list('metab', '1', 'r20.01_kb1000_pvalue', 'pt0.05', '19', "prefix" = 'metab', "fs" = '1', "ldstring" = 'r20.01_kb1000_pvalue', "Rstring" = 'pt0.05', "chrom" = '19'),
    threads = 1,
    log = list(),

...
snakemake <- Snakemake(
    ...
    output = list('../../data/gfa_intermediate_data/metab_zmat.ldpruned_r20.01_kb1000_pvalue.1.RDS', "out" = '../../data/gfa_intermediate_data/metab_zmat.ldpruned_r20.01_kb1000_pvalue.1.RDS'),
    ...
    wildcards = list('metab', '0.01', '1000', 'pvalue', '1', "prefix" = 'metab', "r2_thresh" = '0.01', "kb" = '1000', "p" = 'pvalue', "chrom" = '1'),
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'mem_mib', 'disk_mb', 'disk_mib', 'tmpdir', "mem_mb" = 2181, "mem_mib" = 2080, "disk_mb" = 2181, "disk_mib" = 2080, "tmpdir" = '/tmp'),

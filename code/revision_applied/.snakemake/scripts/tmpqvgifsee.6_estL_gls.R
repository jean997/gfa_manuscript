...
snakemake <- Snakemake(
    input = list('../../data/gfa_intermediate_data/metab_zmat.13.RDS', '../../results/applied_analysis/gfa_results/metab_gfa_gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc.final.RDS', '../../data/gfa_intermediate_data/metab_R_estimate.R_ldsc.RDS', "z_file" = '../../data/gfa_intermediate_data/metab_zmat.13.RDS', "gfa_file" = '../../results/applied_analysis/gfa_results/metab_gfa_gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc.final.RDS', "R" = '../../data/gfa_intermediate_data/metab_R_estimate.R_ldsc.RDS'),
    output = list('../../results/applied_analysis/gfa_results/metab_gls_loadings.gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc.13.RDS', "out" = '../../results/applied_analysis/gfa_results/metab_gls_loadings.gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc.13.RDS'),
    params = list(),
    wildcards = list('metab', '1_cn100', 'r20.01_kb1000_pvalue_jitter0_0', 'ldsc', '13', "prefix" = 'metab', "fs" = '1_cn100', "ldstring" = 'r20.01_kb1000_pvalue_jitter0_0', "Rstring" = 'ldsc', "chrom" = '13'),
    threads = 1,
    log = list(),

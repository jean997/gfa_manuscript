...
snakemake <- Snakemake(
    ...
    output = list('../../results/applied_analysis/gfa_results/bc97v2_gfa_gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_pt0.05_cc1.1.RDS', "out" = '../../results/applied_analysis/gfa_results/bc97v2_gfa_gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_pt0.05_cc1.1.RDS'),
    params = list('default', 'Inf', "params_file" = 'default', "max_snps" = 'Inf'),
    wildcards = list('bc97v2', '1', 'r20.01_kb1000_pvalue', 'pt0.05_cc1', "prefix" = 'bc97v2', "fs" = '1', "ldstring" = 'r20.01_kb1000_pvalue', "Rstring" = 'pt0.05_cc1'),
    threads = 1,
    log = list(),

...
snakemake <- Snakemake(
    input = list('../../data/gfa_intermediate_data/metab_zmat.17.RDS', '/nfs/turbo/sph-jvmorr/ld_reference_files/1kg_plink/EUR.bed', "zmat" = '../../data/gfa_intermediate_data/metab_zmat.17.RDS', "bfile" = '/nfs/turbo/sph-jvmorr/ld_reference_files/1kg_plink/EUR.bed'),
    output = list('../../data/gfa_intermediate_data/metab_zmat.ldpruned_r20.01_kb1000_pvalue_jitter0.5_1.17.RDS', "out" = '../../data/gfa_intermediate_data/metab_zmat.ldpruned_r20.01_kb1000_pvalue_jitter0.5_1.17.RDS'),
    ...
    wildcards = list('metab', '0.01', '1000', 'pvalue', '0.5', '1', '17', "prefix" = 'metab', "r2_thresh" = '0.01', "kb" = '1000', "p" = 'pvalue', "jitter_sd" = '0.5', "jitter_seed" = '1', "chrom" = '17'),
    threads = 1,
    log = list(),

...
snakemake <- Snakemake(
    input = list('../../data/gfa_intermediate_data/bc90_zmat.12.RDS', '/nfs/turbo/sph-jvmorr/ld_reference_files/1kg_plink/EUR.bed', "zmat" = '../../data/gfa_intermediate_data/bc90_zmat.12.RDS', "bfile" = '/nfs/turbo/sph-jvmorr/ld_reference_files/1kg_plink/EUR.bed'),
    output = list('../../data/gfa_intermediate_data/bc90_zmat.ldpruned_r20.01_kb1000_pvalue.12.RDS', "out" = '../../data/gfa_intermediate_data/bc90_zmat.ldpruned_r20.01_kb1000_pvalue.12.RDS'),
    ...
    wildcards = list('bc90', '0.01', '1000', 'pvalue', '12', "prefix" = 'bc90', "r2_thresh" = '0.01', "kb" = '1000', "p" = 'pvalue', "chrom" = '12'),
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'mem_mib', 'disk_mb', 'disk_mib', 'tmpdir', "mem_mb" = 2283, "mem_mib" = 2178, "disk_mb" = 2283, "disk_mib" = 2178, "tmpdir" = '/tmp'),

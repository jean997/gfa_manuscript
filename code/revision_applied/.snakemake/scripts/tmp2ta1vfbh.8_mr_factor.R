...
snakemake <- Snakemake(
    ...
    wildcards = list('bc', 'Chiou_2021_34012112__type-1-diabetes', 'gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc', "prefix" = 'bc', "outcome" = 'Chiou_2021_34012112__type-1-diabetes', "analysis" = 'gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc'),
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'mem_mib', 'disk_mb', 'disk_mib', 'tmpdir', "mem_mb" = 12516, "mem_mib" = 11937, "disk_mb" = 12516, "disk_mib" = 11937, "tmpdir" = '/tmp'),

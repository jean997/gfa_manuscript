...
snakemake <- Snakemake(
    input = list('../../results/applied_analysis/gfa_results/metab_gfa_gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc.final.RDS', "gfa_fit" = '../../results/applied_analysis/gfa_results/metab_gfa_gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc.final.RDS'),
    output = list('../../results/applied_analysis/plots/metab_plot.gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc.png', '../../results/applied_analysis/gfa_results/metab_pveci_gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc.RDS', "out" = '../../results/applied_analysis/plots/metab_plot.gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc.png', "pve_ci" = '../../results/applied_analysis/gfa_results/metab_pveci_gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc.RDS'),
    params = list(1000, 0.05, "nsamp" = 1000, "level" = 0.05),
    wildcards = list('gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc', "analysis" = 'gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc'),
    threads = 1,
    log = list(),

...
snakemake <- Snakemake(
    input = list('../../data/gfa_intermediate_data/bc97v2_zmat.5.RDS', '/nfs/turbo/sph-jvmorr/ld_reference_files/1kg_plink/EUR.bed', "zmat" = '../../data/gfa_intermediate_data/bc97v2_zmat.5.RDS', "bfile" = '/nfs/turbo/sph-jvmorr/ld_reference_files/1kg_plink/EUR.bed'),
    output = list('../../data/gfa_intermediate_data/bc97v2_zmat.ldpruned_r20.01_kb1000_pvalue.5.RDS', "out" = '../../data/gfa_intermediate_data/bc97v2_zmat.ldpruned_r20.01_kb1000_pvalue.5.RDS'),
    ...
    wildcards = list('bc97v2', '0.01', '1000', 'pvalue', '5', "prefix" = 'bc97v2', "r2_thresh" = '0.01', "kb" = '1000', "p" = 'pvalue', "chrom" = '5'),
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'mem_mib', 'disk_mb', 'disk_mib', 'tmpdir', "mem_mb" = 2546, "mem_mib" = 2429, "disk_mb" = 2546, "disk_mib" = 2429, "tmpdir" = '/tmp'),

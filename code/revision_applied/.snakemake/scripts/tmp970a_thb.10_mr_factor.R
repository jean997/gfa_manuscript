...
snakemake <- Snakemake(
    ...
    wildcards = list('bc', 'Demenais_2017_29273806__asthma', 'gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc', "prefix" = 'bc', "outcome" = 'Demenais_2017_29273806__asthma', "analysis" = 'gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc'),
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'mem_mib', 'disk_mb', 'disk_mib', 'tmpdir', "mem_mb" = 3147, "mem_mib" = 3002, "disk_mb" = 3147, "disk_mib" = 3002, "tmpdir" = '/tmp'),

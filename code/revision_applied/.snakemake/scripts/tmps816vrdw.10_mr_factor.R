...
snakemake <- Snakemake(
    ...
    wildcards = list('bc', 'Patsopoulos_2019_31604244__multiple-sclerosis', 'gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc', "prefix" = 'bc', "outcome" = 'Patsopoulos_2019_31604244__multiple-sclerosis', "analysis" = 'gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc'),
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'mem_mib', 'disk_mb', 'disk_mib', 'tmpdir', "mem_mb" = 3337, "mem_mib" = 3183, "disk_mb" = 3337, "disk_mib" = 3183, "tmpdir" = '/tmp'),

...
snakemake <- Snakemake(
    ...
    output = list('../../results/applied_analysis/gfa_results/bc_gfa_gfaseed2_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0.5_1.R_pt0.05.1.RDS', "out" = '../../results/applied_analysis/gfa_results/bc_gfa_gfaseed2_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0.5_1.R_pt0.05.1.RDS'),
    params = list('default', 'Inf', "params_file" = 'default', "max_snps" = 'Inf'),
    wildcards = list('bc', '2', '100', 'r20.01_kb1000_pvalue_jitter0.5_1', 'pt0.05', "prefix" = 'bc', "fs" = '2', "cond_num" = '100', "ldstring" = 'r20.01_kb1000_pvalue_jitter0.5_1', "Rstring" = 'pt0.05'),
    threads = 1,
    log = list(),

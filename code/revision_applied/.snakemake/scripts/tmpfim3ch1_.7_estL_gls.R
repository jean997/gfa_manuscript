...
snakemake <- Snakemake(
    input = list('../../data/gfa_intermediate_data/bc_zmat.17.RDS', '../../results/applied_analysis/gfa_results/bc_gfa_gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_none.final.RDS', '../../data/gfa_intermediate_data/bc_R_estimate.R_none.RDS', "z_file" = '../../data/gfa_intermediate_data/bc_zmat.17.RDS', "gfa_file" = '../../results/applied_analysis/gfa_results/bc_gfa_gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_none.final.RDS', "R" = '../../data/gfa_intermediate_data/bc_R_estimate.R_none.RDS'),
    output = list('../../results/applied_analysis/gfa_results/bc_gls_loadings.gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_none.17.RDS', "out" = '../../results/applied_analysis/gfa_results/bc_gls_loadings.gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_none.17.RDS'),
    params = list(),
    wildcards = list('bc', '1_cn100', 'r20.01_kb1000_pvalue_jitter0_0', 'none', '17', "prefix" = 'bc', "fs" = '1_cn100', "ldstring" = 'r20.01_kb1000_pvalue_jitter0_0', "Rstring" = 'none', "chrom" = '17'),
    threads = 1,
    log = list(),

...
snakemake <- Snakemake(
    input = list('../../data/gfa_intermediate_data/bc_zmat.2.RDS', '../../results/gfa_results/bc_gfa_gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_none.final.RDS', '../../data/gfa_intermediate_data/bc_R_estimate.R_none.RDS', "z_file" = '../../data/gfa_intermediate_data/bc_zmat.2.RDS', "gfa_file" = '../../results/gfa_results/bc_gfa_gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_none.final.RDS', "R" = '../../data/gfa_intermediate_data/bc_R_estimate.R_none.RDS'),
    output = list('../../results/gfa_results/bc_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_none.2.RDS', "out" = '../../results/gfa_results/bc_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_none.2.RDS'),
    params = list(),

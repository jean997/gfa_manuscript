...
snakemake <- Snakemake(
    input = list('../../data/gfa_intermediate_data/metab_zmat.15.RDS', '../../results/gfa_results/metab_gfa_gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_none.final.RDS', '../../data/gfa_intermediate_data/metab_R_estimate.R_none.RDS', "z_file" = '../../data/gfa_intermediate_data/metab_zmat.15.RDS', "gfa_file" = '../../results/gfa_results/metab_gfa_gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_none.final.RDS', "R" = '../../data/gfa_intermediate_data/metab_R_estimate.R_none.RDS'),
    output = list('../../results/gfa_results/metab_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_none.15.RDS', "out" = '../../results/gfa_results/metab_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_none.15.RDS'),
    params = list(),

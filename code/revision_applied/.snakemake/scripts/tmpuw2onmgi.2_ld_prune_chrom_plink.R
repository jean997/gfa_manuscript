...
snakemake <- Snakemake(
    input = list('../../data/gfa_intermediate_data/bc97_zmat.10.RDS', '/nfs/turbo/sph-jvmorr/ld_reference_files/1kg_plink/EUR.bed', "zmat" = '../../data/gfa_intermediate_data/bc97_zmat.10.RDS', "bfile" = '/nfs/turbo/sph-jvmorr/ld_reference_files/1kg_plink/EUR.bed'),
    output = list('../../data/gfa_intermediate_data/bc97_zmat.ldpruned_r20.01_kb1000_pvalue.10.RDS', "out" = '../../data/gfa_intermediate_data/bc97_zmat.ldpruned_r20.01_kb1000_pvalue.10.RDS'),
    ...
    wildcards = list('bc97', '0.01', '1000', 'pvalue', '10', "prefix" = 'bc97', "r2_thresh" = '0.01', "kb" = '1000', "p" = 'pvalue', "chrom" = '10'),
    threads = 1,
    log = list(),

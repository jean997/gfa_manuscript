...
snakemake <- Snakemake(
    input = list('orig_metab_traits.csv', "gwas_info" = 'orig_metab_traits.csv'),
    output = list('../../data/gfa_intermediate_data/metab_R_estimate.R_none.RDS', "out" = '../../data/gfa_intermediate_data/metab_R_estimate.R_none.RDS'),
    params = list(),

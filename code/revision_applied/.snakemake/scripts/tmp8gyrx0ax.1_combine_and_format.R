...
snakemake <- Snakemake(
    ...
    output = list('../../data/gfa_intermediate_data/metab_zmat.14.RDS', "out" = '../../data/gfa_intermediate_data/metab_zmat.14.RDS'),
    params = list(0.01, 0.1, "af_thresh" = 0.01, "sample_size_tol" = 0.1),
    wildcards = list('metab', '14', "prefix" = 'metab', "chrom" = '14'),
    threads = 1,
    log = list(),

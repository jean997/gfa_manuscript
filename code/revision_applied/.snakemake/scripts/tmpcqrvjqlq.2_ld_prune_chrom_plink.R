...
snakemake <- Snakemake(
    ...
    output = list('../../data/gfa_intermediate_data/bc_zmat.ldpruned_r20.01_kb1000_pvalue.10.RDS', "out" = '../../data/gfa_intermediate_data/bc_zmat.ldpruned_r20.01_kb1000_pvalue.10.RDS'),
    ...
    wildcards = list('bc', '0.01', '1000', 'pvalue', '10', "prefix" = 'bc', "r2_thresh" = '0.01', "kb" = '1000', "p" = 'pvalue', "chrom" = '10'),
    threads = 1,
    log = list(),

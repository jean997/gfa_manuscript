...
snakemake <- Snakemake(
    ...
    output = list('../../data/gfa_intermediate_data/metab_zmat.ldpruned_r20.01_kb1000_pvalue_jitter0.5_3.19.RDS', "out" = '../../data/gfa_intermediate_data/metab_zmat.ldpruned_r20.01_kb1000_pvalue_jitter0.5_3.19.RDS'),
    ...
    wildcards = list('metab', '0.01', '1000', 'pvalue', '0.5', '3', '19', "prefix" = 'metab', "r2_thresh" = '0.01', "kb" = '1000', "p" = 'pvalue', "jitter_sd" = '0.5', "jitter_seed" = '3', "chrom" = '19'),
    threads = 1,
    log = list(),

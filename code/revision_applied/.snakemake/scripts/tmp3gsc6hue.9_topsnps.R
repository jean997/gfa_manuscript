...
snakemake <- Snakemake(
    input = list('../../results/applied_analysis/gfa_results/bc_gls_loadings.gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_pt0.05.15.RDS', "Z" = '../../results/applied_analysis/gfa_results/bc_gls_loadings.gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_pt0.05.15.RDS'),
    output = list('../../results/applied_analysis/gfa_results/bc_gls_loadings.gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_pt0.05.top_snps.15.RDS', "out" = '../../results/applied_analysis/gfa_results/bc_gls_loadings.gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_pt0.05.top_snps.15.RDS'),
    ...
    wildcards = list('bc', 'gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_pt0.05', '15', "prefix" = 'bc', "analysis" = 'gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_pt0.05', "chrom" = '15'),
    threads = 1,
    log = list(),

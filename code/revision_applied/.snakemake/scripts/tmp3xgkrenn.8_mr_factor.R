...
snakemake <- Snakemake(
    ...
    wildcards = list('bc', 'Okada_2014_24390342__rheumatoid-arthritis', 'gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc', "prefix" = 'bc', "outcome" = 'Okada_2014_24390342__rheumatoid-arthritis', "analysis" = 'gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc'),
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'mem_mib', 'disk_mb', 'disk_mib', 'tmpdir', "mem_mb" = 3271, "mem_mib" = 3120, "disk_mb" = 3271, "disk_mib" = 3120, "tmpdir" = '/tmp'),

...
snakemake <- Snakemake(
    ...
    wildcards = list('bc', 'Liu_2015_26192919__inflammatory-bowel-disease', 'gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc', "prefix" = 'bc', "outcome" = 'Liu_2015_26192919__inflammatory-bowel-disease', "analysis" = 'gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc'),
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'mem_mib', 'disk_mb', 'disk_mib', 'tmpdir', "mem_mb" = 3717, "mem_mib" = 3545, "disk_mb" = 3717, "disk_mib" = 3545, "tmpdir" = '/tmp'),

...
snakemake <- Snakemake(
    input = list('../../results/gfa_results/bc_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_ldsc.20.RDS', "Z" = '../../results/gfa_results/bc_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_ldsc.20.RDS'),
    output = list('../../results/gfa_results/bc_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_ldsc.top_snps.20.RDS', "out" = '../../results/gfa_results/bc_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_ldsc.top_snps.20.RDS'),

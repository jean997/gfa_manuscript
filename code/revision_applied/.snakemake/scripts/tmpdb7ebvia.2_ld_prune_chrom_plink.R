...
snakemake <- Snakemake(
    input = list('../../data/gfa_intermediate_data/bc95_zmat.3.RDS', '/nfs/turbo/sph-jvmorr/ld_reference_files/1kg_plink/EUR.bed', "zmat" = '../../data/gfa_intermediate_data/bc95_zmat.3.RDS', "bfile" = '/nfs/turbo/sph-jvmorr/ld_reference_files/1kg_plink/EUR.bed'),
    output = list('../../data/gfa_intermediate_data/bc95_zmat.ldpruned_r20.01_kb1000_pvalue.3.RDS', "out" = '../../data/gfa_intermediate_data/bc95_zmat.ldpruned_r20.01_kb1000_pvalue.3.RDS'),
    ...
    wildcards = list('bc95', '0.01', '1000', 'pvalue', '3', "prefix" = 'bc95', "r2_thresh" = '0.01', "kb" = '1000', "p" = 'pvalue', "chrom" = '3'),
    threads = 1,
    log = list(),

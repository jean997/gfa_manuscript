...
snakemake <- Snakemake(
    input = list('../../data/gfa_intermediate_data/metab_zmat.17.RDS', '../../results/gfa_results/metab_gfa_gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_pt0.05.final.RDS', '../../data/gfa_intermediate_data/metab_R_estimate.ldpruned_r20.01_kb1000_pvalue.R_pt0.05.RDS', "z_file" = '../../data/gfa_intermediate_data/metab_zmat.17.RDS', "gfa_file" = '../../results/gfa_results/metab_gfa_gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_pt0.05.final.RDS', "R" = '../../data/gfa_intermediate_data/metab_R_estimate.ldpruned_r20.01_kb1000_pvalue.R_pt0.05.RDS'),
    output = list('../../results/gfa_results/metab_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_pt0.05.17.RDS', "out" = '../../results/gfa_results/metab_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_pt0.05.17.RDS'),
    params = list(),

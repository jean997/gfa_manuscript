...
snakemake <- Snakemake(
    ...
    output = list('../../results/applied_analysis/gfa_results/bc97v2_gfa_gfaseed3.ldpruned_r20.01_kb1000_pvalue.R_ldsc_cc1.1.RDS', "out" = '../../results/applied_analysis/gfa_results/bc97v2_gfa_gfaseed3.ldpruned_r20.01_kb1000_pvalue.R_ldsc_cc1.1.RDS'),
    params = list('default', 'Inf', "params_file" = 'default', "max_snps" = 'Inf'),
    wildcards = list('bc97v2', '3', 'r20.01_kb1000_pvalue', 'ldsc_cc1', "prefix" = 'bc97v2', "fs" = '3', "ldstring" = 'r20.01_kb1000_pvalue', "Rstring" = 'ldsc_cc1'),
    threads = 1,
    log = list(),

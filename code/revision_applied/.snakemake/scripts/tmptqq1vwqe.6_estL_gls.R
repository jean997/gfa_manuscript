...
snakemake <- Snakemake(
    input = list('../../data/gfa_intermediate_data/metab_zmat.11.RDS', '../../results/applied_analysis/gfa_results/metab_gfa_gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_ldsc.final.RDS', '../../data/gfa_intermediate_data/metab_R_estimate.R_ldsc.RDS', "z_file" = '../../data/gfa_intermediate_data/metab_zmat.11.RDS', "gfa_file" = '../../results/applied_analysis/gfa_results/metab_gfa_gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_ldsc.final.RDS', "R" = '../../data/gfa_intermediate_data/metab_R_estimate.R_ldsc.RDS'),
    output = list('../../results/applied_analysis/gfa_results/metab_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_ldsc.11.RDS', "out" = '../../results/applied_analysis/gfa_results/metab_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_ldsc.11.RDS'),
    params = list(),
    wildcards = list('metab', '1', 'r20.01_kb1000_pvalue', 'ldsc', '11', "prefix" = 'metab', "fs" = '1', "ldstring" = 'r20.01_kb1000_pvalue', "Rstring" = 'ldsc', "chrom" = '11'),
    threads = 1,
    log = list(),

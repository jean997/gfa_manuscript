...
snakemake <- Snakemake(
    input = list('../../data/gfa_intermediate_data/bc_zmat.18.RDS', '../../results/applied_analysis/gfa_results/bc_gfa_gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_pt0.05.final.RDS', '../../data/gfa_intermediate_data/bc_R_estimate.ldpruned_r20.01_kb1000_pvalue.R_pt0.05.RDS', "z_file" = '../../data/gfa_intermediate_data/bc_zmat.18.RDS', "gfa_file" = '../../results/applied_analysis/gfa_results/bc_gfa_gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_pt0.05.final.RDS', "R" = '../../data/gfa_intermediate_data/bc_R_estimate.ldpruned_r20.01_kb1000_pvalue.R_pt0.05.RDS'),
    output = list('../../results/applied_analysis/gfa_results/bc_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_pt0.05.18.RDS', "out" = '../../results/applied_analysis/gfa_results/bc_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_pt0.05.18.RDS'),
    params = list(),
    wildcards = list('bc', '1', 'r20.01_kb1000_pvalue', 'pt0.05', '18', "prefix" = 'bc', "fs" = '1', "ldstring" = 'r20.01_kb1000_pvalue', "Rstring" = 'pt0.05', "chrom" = '18'),
    threads = 1,
    log = list(),

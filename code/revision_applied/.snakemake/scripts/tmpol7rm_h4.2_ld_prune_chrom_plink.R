...
snakemake <- Snakemake(
    input = list('../../data/gfa_intermediate_data/bc_zmat.21.RDS', '/nfs/turbo/sph-jvmorr/ld_reference_files/1kg_plink/EUR.bed', "zmat" = '../../data/gfa_intermediate_data/bc_zmat.21.RDS', "bfile" = '/nfs/turbo/sph-jvmorr/ld_reference_files/1kg_plink/EUR.bed'),
    output = list('../../data/gfa_intermediate_data/bc_zmat.ldpruned_r20.01_kb1000_pvalue_jitter0.5_1.21.RDS', "out" = '../../data/gfa_intermediate_data/bc_zmat.ldpruned_r20.01_kb1000_pvalue_jitter0.5_1.21.RDS'),
    ...
    wildcards = list('bc', '0.01', '1000', 'pvalue', '0.5', '1', '21', "prefix" = 'bc', "r2_thresh" = '0.01', "kb" = '1000', "p" = 'pvalue', "jitter_sd" = '0.5', "jitter_seed" = '1', "chrom" = '21'),
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'mem_mib', 'disk_mb', 'disk_mib', 'tmpdir', "mem_mb" = 2179, "mem_mib" = 2079, "disk_mb" = 2179, "disk_mib" = 2079, "tmpdir" = '/tmp'),

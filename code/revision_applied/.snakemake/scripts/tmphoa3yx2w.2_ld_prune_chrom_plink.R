...
snakemake <- Snakemake(
    input = list('../../data/gfa_intermediate_data/metab_zmat.10.RDS', '/nfs/turbo/sph-jvmorr/ld_reference_files/1kg_plink/EUR.bed', "zmat" = '../../data/gfa_intermediate_data/metab_zmat.10.RDS', "bfile" = '/nfs/turbo/sph-jvmorr/ld_reference_files/1kg_plink/EUR.bed'),
    output = list('../../data/gfa_intermediate_data/metab_zmat.ldpruned_r20.01_kb1000_pvalue_jitter0.5_3.10.RDS', "out" = '../../data/gfa_intermediate_data/metab_zmat.ldpruned_r20.01_kb1000_pvalue_jitter0.5_3.10.RDS'),
    ...
    wildcards = list('metab', '0.01', '1000', 'pvalue', '0.5', '3', '10', "prefix" = 'metab', "r2_thresh" = '0.01', "kb" = '1000', "p" = 'pvalue', "jitter_sd" = '0.5', "jitter_seed" = '3', "chrom" = '10'),
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'mem_mib', 'disk_mb', 'disk_mib', 'tmpdir', "mem_mb" = 2158, "mem_mib" = 2059, "disk_mb" = 2158, "disk_mib" = 2059, "tmpdir" = '/tmp'),

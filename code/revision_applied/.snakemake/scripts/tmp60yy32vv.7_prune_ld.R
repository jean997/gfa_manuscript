...
snakemake <- Snakemake(
    input = list('../../results/applied_analysis/gfa_results/bc_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_pt0.05.4.RDS', "Z" = '../../results/applied_analysis/gfa_results/bc_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_pt0.05.4.RDS'),
    output = list('../../results/applied_analysis/gfa_results/bc_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_pt0.05.top_snps.4.RDS', "out" = '../../results/applied_analysis/gfa_results/bc_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_pt0.05.top_snps.4.RDS'),
    ...
    wildcards = list('bc', 'gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_pt0.05', '4', "prefix" = 'bc', "analysis" = 'gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_pt0.05', "chrom" = '4'),
    threads = 1,
    log = list(),

...
snakemake <- Snakemake(
    ...
    output = list('../../data/gfa_intermediate_data/bc_zmat.ldpruned_r20.01_kb1000_pvalue.16.RDS', "out" = '../../data/gfa_intermediate_data/bc_zmat.ldpruned_r20.01_kb1000_pvalue.16.RDS'),
    ...
    wildcards = list('bc', '0.01', '1000', 'pvalue', '16', "prefix" = 'bc', "r2_thresh" = '0.01', "kb" = '1000', "p" = 'pvalue', "chrom" = '16'),
    threads = 1,
    log = list(),

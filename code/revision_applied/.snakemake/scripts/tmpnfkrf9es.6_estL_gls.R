...
snakemake <- Snakemake(
    input = list('../../data/gfa_intermediate_data/metab_zmat.7.RDS', '../../results/applied_analysis/gfa_results/metab_gfa_gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_none.final.RDS', '../../data/gfa_intermediate_data/metab_R_estimate.R_none.RDS', "z_file" = '../../data/gfa_intermediate_data/metab_zmat.7.RDS', "gfa_file" = '../../results/applied_analysis/gfa_results/metab_gfa_gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_none.final.RDS', "R" = '../../data/gfa_intermediate_data/metab_R_estimate.R_none.RDS'),
    output = list('../../results/applied_analysis/gfa_results/metab_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_none.7.RDS', "out" = '../../results/applied_analysis/gfa_results/metab_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_none.7.RDS'),
    params = list(),
    wildcards = list('metab', '1', 'r20.01_kb1000_pvalue', 'none', '7', "prefix" = 'metab', "fs" = '1', "ldstring" = 'r20.01_kb1000_pvalue', "Rstring" = 'none', "chrom" = '7'),
    threads = 1,
    log = list(),

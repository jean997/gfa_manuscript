...
snakemake <- Snakemake(
    ...
    output = list('../../data/gfa_intermediate_data/bc_zmat.ldpruned_r20.01_kb1000_pvalue_jitter0.5_1.20.RDS', "out" = '../../data/gfa_intermediate_data/bc_zmat.ldpruned_r20.01_kb1000_pvalue_jitter0.5_1.20.RDS'),
    ...
    wildcards = list('bc', '0.01', '1000', 'pvalue', '0.5', '1', '20', "prefix" = 'bc', "r2_thresh" = '0.01', "kb" = '1000', "p" = 'pvalue', "jitter_sd" = '0.5', "jitter_seed" = '1', "chrom" = '20'),
    threads = 1,
    log = list(),

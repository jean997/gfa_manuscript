...
snakemake <- Snakemake(
    input = list('../../data/gfa_intermediate_data/metab_zmat.11.RDS', '/nfs/turbo/sph-jvmorr/ld_reference_files/1kg_plink/EUR.bed', "zmat" = '../../data/gfa_intermediate_data/metab_zmat.11.RDS', "bfile" = '/nfs/turbo/sph-jvmorr/ld_reference_files/1kg_plink/EUR.bed'),
    output = list('../../data/gfa_intermediate_data/metab_zmat.ldpruned_r20.01_kb1000_pvalue_jitter0.5_1.11.RDS', "out" = '../../data/gfa_intermediate_data/metab_zmat.ldpruned_r20.01_kb1000_pvalue_jitter0.5_1.11.RDS'),
    ...
    wildcards = list('metab', '0.01', '1000', 'pvalue', '0.5', '1', '11', "prefix" = 'metab', "r2_thresh" = '0.01', "kb" = '1000', "p" = 'pvalue', "jitter_sd" = '0.5', "jitter_seed" = '1', "chrom" = '11'),
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'mem_mib', 'disk_mb', 'disk_mib', 'tmpdir', "mem_mb" = 2155, "mem_mib" = 2056, "disk_mb" = 2155, "disk_mib" = 2056, "tmpdir" = '/tmp'),

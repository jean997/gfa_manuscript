...
snakemake <- Snakemake(
    input = list('../../data/gfa_intermediate_data/bc_zmat.8.RDS', '../../results/applied_analysis/gfa_results/bc_gfa_gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_pt0.05.final.RDS', '../../data/gfa_intermediate_data/bc_R_estimate.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_pt0.05.RDS', "z_file" = '../../data/gfa_intermediate_data/bc_zmat.8.RDS', "gfa_file" = '../../results/applied_analysis/gfa_results/bc_gfa_gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_pt0.05.final.RDS', "R" = '../../data/gfa_intermediate_data/bc_R_estimate.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_pt0.05.RDS'),
    output = list('../../results/applied_analysis/gfa_results/bc_gls_loadings.gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_pt0.05.8.RDS', "out" = '../../results/applied_analysis/gfa_results/bc_gls_loadings.gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_pt0.05.8.RDS'),
    params = list(),
    wildcards = list('bc', '1_cn100', 'r20.01_kb1000_pvalue_jitter0_0', 'pt0.05', '8', "prefix" = 'bc', "fs" = '1_cn100', "ldstring" = 'r20.01_kb1000_pvalue_jitter0_0', "Rstring" = 'pt0.05', "chrom" = '8'),
    threads = 1,
    log = list(),

...
snakemake <- Snakemake(
    ...
    output = list('../../data/gfa_intermediate_data/bc97v2_zmat.17.RDS', "out" = '../../data/gfa_intermediate_data/bc97v2_zmat.17.RDS'),
    params = list(0.01, 0.1, "af_thresh" = 0.01, "sample_size_tol" = 0.1),
    wildcards = list('bc97v2', '17', "prefix" = 'bc97v2', "chrom" = '17'),
    threads = 1,
    log = list(),

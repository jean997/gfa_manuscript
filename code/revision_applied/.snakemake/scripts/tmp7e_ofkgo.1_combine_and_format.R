...
snakemake <- Snakemake(
    ...
    output = list('../../data/gfa_intermediate_data/bc95v2_zmat.20.RDS', "out" = '../../data/gfa_intermediate_data/bc95v2_zmat.20.RDS'),
    params = list(0.01, 0.1, "af_thresh" = 0.01, "sample_size_tol" = 0.1),
    wildcards = list('bc95v2', '20', "prefix" = 'bc95v2', "chrom" = '20'),
    threads = 1,
    log = list(),

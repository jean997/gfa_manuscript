...
snakemake <- Snakemake(
    ...
    wildcards = list('bc', 'deLange_2018_28067909__ulcerative-colitis', 'gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc', "prefix" = 'bc', "outcome" = 'deLange_2018_28067909__ulcerative-colitis', "analysis" = 'gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc'),
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'mem_mib', 'disk_mb', 'disk_mib', 'tmpdir', "mem_mb" = 3440, "mem_mib" = 3281, "disk_mb" = 3440, "disk_mib" = 3281, "tmpdir" = '/tmp'),

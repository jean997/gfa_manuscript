...
snakemake <- Snakemake(
    ...
    output = list('../../data/gfa_intermediate_data/metab_zmat.ldpruned_r20.01_kb1000_pvalue.7.RDS', "out" = '../../data/gfa_intermediate_data/metab_zmat.ldpruned_r20.01_kb1000_pvalue.7.RDS'),
    ...
    wildcards = list('metab', '0.01', '1000', 'pvalue', '7', "prefix" = 'metab', "r2_thresh" = '0.01', "kb" = '1000', "p" = 'pvalue', "chrom" = '7'),
    threads = 1,
    log = list(),

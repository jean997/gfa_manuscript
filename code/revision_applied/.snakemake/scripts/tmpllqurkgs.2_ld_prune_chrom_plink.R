...
snakemake <- Snakemake(
    input = list('../../data/gfa_intermediate_data/bc90_zmat.20.RDS', '/nfs/turbo/sph-jvmorr/ld_reference_files/1kg_plink/EUR.bed', "zmat" = '../../data/gfa_intermediate_data/bc90_zmat.20.RDS', "bfile" = '/nfs/turbo/sph-jvmorr/ld_reference_files/1kg_plink/EUR.bed'),
    output = list('../../data/gfa_intermediate_data/bc90_zmat.ldpruned_r20.01_kb1000_pvalue.20.RDS', "out" = '../../data/gfa_intermediate_data/bc90_zmat.ldpruned_r20.01_kb1000_pvalue.20.RDS'),
    ...
    wildcards = list('bc90', '0.01', '1000', 'pvalue', '20', "prefix" = 'bc90', "r2_thresh" = '0.01', "kb" = '1000', "p" = 'pvalue', "chrom" = '20'),
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'mem_mib', 'disk_mb', 'disk_mib', 'tmpdir', "mem_mb" = 2161, "mem_mib" = 2061, "disk_mb" = 2161, "disk_mib" = 2061, "tmpdir" = '/tmp'),

...
snakemake <- Snakemake(
    input = list('../../data/gfa_intermediate_data/bc_zmat.3.RDS', '../../results/applied_analysis/gfa_results/bc_gfa_gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_ldsc.final.RDS', '../../data/gfa_intermediate_data/bc_R_estimate.R_ldsc.RDS', "z_file" = '../../data/gfa_intermediate_data/bc_zmat.3.RDS', "gfa_file" = '../../results/applied_analysis/gfa_results/bc_gfa_gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_ldsc.final.RDS', "R" = '../../data/gfa_intermediate_data/bc_R_estimate.R_ldsc.RDS'),
    output = list('../../results/applied_analysis/gfa_results/bc_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_ldsc.3.RDS', "out" = '../../results/applied_analysis/gfa_results/bc_gls_loadings.gfaseed1.ldpruned_r20.01_kb1000_pvalue.R_ldsc.3.RDS'),
    params = list(),
    wildcards = list('bc', '1', 'r20.01_kb1000_pvalue', 'ldsc', '3', "prefix" = 'bc', "fs" = '1', "ldstring" = 'r20.01_kb1000_pvalue', "Rstring" = 'ldsc', "chrom" = '3'),
    threads = 1,
    log = list(),

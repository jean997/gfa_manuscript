...
snakemake <- Snakemake(
    input = list('../../results/applied_analysis/gfa_results/metab_gfa_gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_none.final.RDS', "gfa_fit" = '../../results/applied_analysis/gfa_results/metab_gfa_gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_none.final.RDS'),
    ...
    wildcards = list('gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_none', "analysis" = 'gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_none'),
    threads = 1,
    log = list(),

...
snakemake <- Snakemake(
    ...
    wildcards = list('bc', 'Dubois_2010_20190752__celiac-disease', 'gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc', "prefix" = 'bc', "outcome" = 'Dubois_2010_20190752__celiac-disease', "analysis" = 'gfaseed1_cn100.ldpruned_r20.01_kb1000_pvalue_jitter0_0.R_ldsc'),
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'mem_mib', 'disk_mb', 'disk_mib', 'tmpdir', "mem_mb" = 3078, "mem_mib" = 2936, "disk_mb" = 3078, "disk_mib" = 2936, "tmpdir" = '/tmp'),

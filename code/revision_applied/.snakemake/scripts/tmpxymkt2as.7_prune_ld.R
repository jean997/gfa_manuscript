...
snakemake <- Snakemake(
    input = list('../../data/gfa_intermediate_data/bc_zmat.1.RDS', "Z" = '../../data/gfa_intermediate_data/bc_zmat.1.RDS'),
    output = list('../../data/gfa_intermediate_data/bc_trait.top_snps.1.RDS', "out" = '../../data/gfa_intermediate_data/bc_trait.top_snps.1.RDS'),

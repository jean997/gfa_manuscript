...
snakemake <- Snakemake(
    input = list('../../results/simulation_results/simulate/simulate.B3.12.0.RDS', '../../results/simulation_results/svd/svd_4_5e-8.B3.12.0.RDS', "dat" = '../../results/simulation_results/simulate/simulate.B3.12.0.RDS', "fit" = '../../results/simulation_results/svd/svd_4_5e-8.B3.12.0.RDS'),
    output = list('../../results/simulation_results/svd/df_svd_4_5e-8.B3.12.0.RDS', "out" = '../../results/simulation_results/svd/df_svd_4_5e-8.B3.12.0.RDS'),
    params = list(),
    wildcards = list('svd', '4_5e-8', 'B3', '12', '0', "method" = 'svd', "mtype" = '4_5e-8', "scenario" = 'B3', "ndense" = '12', "rep" = '0'),
    threads = 1,
    log = list(),

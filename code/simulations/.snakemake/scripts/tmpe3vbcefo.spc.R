...
snakemake <- Snakemake(
    ...
    output = list('../../results/simulation_results/spc/spc_5e-8.B1.0.0.RDS', "out" = '../../results/simulation_results/spc/spc_5e-8.B1.0.0.RDS'),
    params = list(),
    wildcards = list('5e-8', 'B1', '0', '0', "pthresh" = '5e-8', "scenario" = 'B1', "ndense" = '0', "rep" = '0'),
    threads = 1,
    log = list(),

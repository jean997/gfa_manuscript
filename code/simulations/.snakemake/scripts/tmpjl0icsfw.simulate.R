...
snakemake <- Snakemake(
    input = list(),
    output = list('../../results/simulation_results/simulate/simulate.B1.12.0.RDS', "out" = '../../results/simulation_results/simulate/simulate.B1.12.0.RDS'),
    params = list(),
    wildcards = list('B1', '12', '0', "scenario" = 'B1', "ndense" = '12', "rep" = '0'),
    threads = 1,
    log = list(),

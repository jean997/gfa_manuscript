...
snakemake <- Snakemake(
    ...
    output = list('../../results/simulation_results/svd/svd_0_5e-8.B2.0.0.RDS', "out" = '../../results/simulation_results/svd/svd_0_5e-8.B2.0.0.RDS'),
    params = list(),
    wildcards = list('0', '5e-8', 'B2', '0', '0', "zero_thresh" = '0', "pthresh" = '5e-8', "scenario" = 'B2', "ndense" = '0', "rep" = '0'),
    threads = 1,
    log = list(),

...
snakemake <- Snakemake(
    ...
    output = list('../../results/simulation_results/gfa/gfa_pt0.05_random_1.A.3.0.RDS', "out" = '../../results/simulation_results/gfa/gfa_pt0.05_random_1.A.3.0.RDS'),
    params = list(),
    wildcards = list('pt0.05', 'random', '1', 'A', '3', '0', "Rstring" = 'pt0.05', "ldtype" = 'random', "pthresh" = '1', "scenario" = 'A', "ndense" = '3', "rep" = '0'),
    threads = 1,
    log = list(),

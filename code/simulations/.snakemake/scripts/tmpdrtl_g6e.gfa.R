...
snakemake <- Snakemake(
    ...
    output = list('../../results/simulation_results/gfa/gfa_none_pval_1e-3.B1.3.0.RDS', "out" = '../../results/simulation_results/gfa/gfa_none_pval_1e-3.B1.3.0.RDS'),
    params = list(),
    wildcards = list('none', 'pval', '1e-3', 'B1', '3', '0', "Rstring" = 'none', "ldtype" = 'pval', "pthresh" = '1e-3', "scenario" = 'B1', "ndense" = '3', "rep" = '0'),
    threads = 1,
    log = list(),

...
snakemake <- Snakemake(
    input = list('../../results/simulation_results/simulate/simulate.B2.12.0.RDS', '../../results/simulation_results/gfa/gfa_ldsc_pval_1.B2.12.0.RDS', "dat" = '../../results/simulation_results/simulate/simulate.B2.12.0.RDS', "fit" = '../../results/simulation_results/gfa/gfa_ldsc_pval_1.B2.12.0.RDS'),
    output = list('../../results/simulation_results/gfa/df_gfa_ldsc_pval_1.B2.12.0.RDS', "out" = '../../results/simulation_results/gfa/df_gfa_ldsc_pval_1.B2.12.0.RDS'),
    params = list(),
    wildcards = list('gfa', 'ldsc_pval_1', 'B2', '12', '0', "method" = 'gfa', "mtype" = 'ldsc_pval_1', "scenario" = 'B2', "ndense" = '12', "rep" = '0'),
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'mem_mib', 'disk_mb', 'disk_mib', 'tmpdir', "mem_mb" = 2095, "mem_mib" = 1998, "disk_mb" = 2095, "disk_mib" = 1998, "tmpdir" = '/tmp'),
    config = list(),
    rule = 'eval',

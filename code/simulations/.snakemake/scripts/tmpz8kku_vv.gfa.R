...
snakemake <- Snakemake(
    ...
    output = list('../../results/simulation_results/gfa/gfa_oracle_random_1e-3.A.3.0.RDS', "out" = '../../results/simulation_results/gfa/gfa_oracle_random_1e-3.A.3.0.RDS'),
    params = list(),
    wildcards = list('oracle', 'random', '1e-3', 'A', '3', '0', "Rstring" = 'oracle', "ldtype" = 'random', "pthresh" = '1e-3', "scenario" = 'A', "ndense" = '3', "rep" = '0'),
    threads = 1,
    log = list(),

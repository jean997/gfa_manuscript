...
snakemake <- Snakemake(
    input = list('../../results/simulation_results/simulate/simulate.B1.3.0.RDS', '../../results/simulation_results/ml/ml_12.B1.3.0.RDS', "dat" = '../../results/simulation_results/simulate/simulate.B1.3.0.RDS', "fit" = '../../results/simulation_results/ml/ml_12.B1.3.0.RDS'),
    output = list('../../results/simulation_results/ml/df_ml_12.B1.3.0.RDS', "out" = '../../results/simulation_results/ml/df_ml_12.B1.3.0.RDS'),
    params = list(),
    wildcards = list('ml', '12', 'B1', '3', '0', "method" = 'ml', "mtype" = '12', "scenario" = 'B1', "ndense" = '3', "rep" = '0'),
    threads = 1,
    log = list(),

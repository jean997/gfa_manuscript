...
snakemake <- Snakemake(
    ...
    output = list('../../results/simulation_results/gfa/gfa_oracle_pval_1.B1.12.0.RDS', "out" = '../../results/simulation_results/gfa/gfa_oracle_pval_1.B1.12.0.RDS'),
    params = list(),
    wildcards = list('oracle', 'pval', '1', 'B1', '12', '0', "Rstring" = 'oracle', "ldtype" = 'pval', "pthresh" = '1', "scenario" = 'B1', "ndense" = '12', "rep" = '0'),
    threads = 1,
    log = list(),

...
snakemake <- Snakemake(
    input = list('../../results/simulation_results/simulate/simulate.B3.3.0.RDS', '../../results/simulation_results/svd/svd_0_5e-8.B3.3.0.RDS', "dat" = '../../results/simulation_results/simulate/simulate.B3.3.0.RDS', "fit" = '../../results/simulation_results/svd/svd_0_5e-8.B3.3.0.RDS'),
    output = list('../../results/simulation_results/svd/df_svd_0_5e-8.B3.3.0.RDS', "out" = '../../results/simulation_results/svd/df_svd_0_5e-8.B3.3.0.RDS'),
    params = list(),
    wildcards = list('svd', '0_5e-8', 'B3', '3', '0', "method" = 'svd', "mtype" = '0_5e-8', "scenario" = 'B3', "ndense" = '3', "rep" = '0'),
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'mem_mib', 'disk_mb', 'disk_mib', 'tmpdir', "mem_mb" = 1898, "mem_mib" = 1811, "disk_mb" = 1898, "disk_mib" = 1811, "tmpdir" = '/tmp'),
    config = list(),
    rule = 'eval',

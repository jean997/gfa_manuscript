...
snakemake <- Snakemake(
    input = list('../../results/simulation_results/simulate/simulate.A.3.0.RDS', '../../results/simulation_results/gfa/gfa_ldsc_random_1e-3.A.3.0.RDS', "dat" = '../../results/simulation_results/simulate/simulate.A.3.0.RDS', "fit" = '../../results/simulation_results/gfa/gfa_ldsc_random_1e-3.A.3.0.RDS'),
    output = list('../../results/simulation_results/gfa/df_gfa_ldsc_random_1e-3.A.3.0.RDS', "out" = '../../results/simulation_results/gfa/df_gfa_ldsc_random_1e-3.A.3.0.RDS'),
    params = list(),
    wildcards = list('gfa', 'ldsc_random_1e-3', 'A', '3', '0', "method" = 'gfa', "mtype" = 'ldsc_random_1e-3', "scenario" = 'A', "ndense" = '3', "rep" = '0'),
    threads = 1,
    log = list(),

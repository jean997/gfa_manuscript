...
snakemake <- Snakemake(
    ...
    output = list('../../results/simulation_results/gfa/gfa_ldsc_pval_1.A.0.0.RDS', "out" = '../../results/simulation_results/gfa/gfa_ldsc_pval_1.A.0.0.RDS'),
    params = list(),
    wildcards = list('ldsc', 'pval', '1', 'A', '0', '0', "Rstring" = 'ldsc', "ldtype" = 'pval', "pthresh" = '1', "scenario" = 'A', "ndense" = '0', "rep" = '0'),
    threads = 1,
    log = list(),

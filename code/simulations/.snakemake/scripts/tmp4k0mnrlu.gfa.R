...
snakemake <- Snakemake(
    ...
    output = list('../../results/simulation_results/gfa/gfa_pt0.05_pval_1.A.12.0.RDS', "out" = '../../results/simulation_results/gfa/gfa_pt0.05_pval_1.A.12.0.RDS'),
    params = list(),
    wildcards = list('pt0.05', 'pval', '1', 'A', '12', '0', "Rstring" = 'pt0.05', "ldtype" = 'pval', "pthresh" = '1', "scenario" = 'A', "ndense" = '12', "rep" = '0'),
    threads = 1,
    log = list(),

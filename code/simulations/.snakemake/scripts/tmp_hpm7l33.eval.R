...
snakemake <- Snakemake(
    input = list('../../results/simulation_results/simulate/simulate.B3.3.0.RDS', '../../results/simulation_results/gfa/gfa_oracle_pval_1e-3.B3.3.0.RDS', "dat" = '../../results/simulation_results/simulate/simulate.B3.3.0.RDS', "fit" = '../../results/simulation_results/gfa/gfa_oracle_pval_1e-3.B3.3.0.RDS'),
    output = list('../../results/simulation_results/gfa/df_gfa_oracle_pval_1e-3.B3.3.0.RDS', "out" = '../../results/simulation_results/gfa/df_gfa_oracle_pval_1e-3.B3.3.0.RDS'),
    params = list(),
    wildcards = list('gfa', 'oracle_pval_1e-3', 'B3', '3', '0', "method" = 'gfa', "mtype" = 'oracle_pval_1e-3', "scenario" = 'B3', "ndense" = '3', "rep" = '0'),
    threads = 1,
    log = list(),

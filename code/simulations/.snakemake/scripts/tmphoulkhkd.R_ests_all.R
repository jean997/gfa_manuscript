...
snakemake <- Snakemake(
    ...
    output = list('../../results/simulation_results/R_ests/R_ests.B2.0.0.RDS', "out" = '../../results/simulation_results/R_ests/R_ests.B2.0.0.RDS'),
    params = list(),
    wildcards = list('B2', '0', '0', "scenario" = 'B2', "ndense" = '0', "rep" = '0'),
    threads = 1,
    log = list(),

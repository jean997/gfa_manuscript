...
snakemake <- Snakemake(
    ...
    output = list('../../results/simulation_results/gfa/gfa_none_pval_1.B3.0.0.RDS', "out" = '../../results/simulation_results/gfa/gfa_none_pval_1.B3.0.0.RDS'),
    params = list(),
    wildcards = list('none', 'pval', '1', 'B3', '0', '0', "Rstring" = 'none', "ldtype" = 'pval', "pthresh" = '1', "scenario" = 'B3', "ndense" = '0', "rep" = '0'),
    threads = 1,
    log = list(),

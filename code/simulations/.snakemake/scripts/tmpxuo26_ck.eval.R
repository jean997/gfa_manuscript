...
snakemake <- Snakemake(
    input = list('../../results/simulation_results/simulate/simulate.B3.3.0.RDS', '../../results/simulation_results/spc/spc_5e-8.B3.3.0.RDS', "dat" = '../../results/simulation_results/simulate/simulate.B3.3.0.RDS', "fit" = '../../results/simulation_results/spc/spc_5e-8.B3.3.0.RDS'),
    output = list('../../results/simulation_results/spc/df_spc_5e-8.B3.3.0.RDS', "out" = '../../results/simulation_results/spc/df_spc_5e-8.B3.3.0.RDS'),
    params = list(),
    wildcards = list('spc', '5e-8', 'B3', '3', '0', "method" = 'spc', "mtype" = '5e-8', "scenario" = 'B3', "ndense" = '3', "rep" = '0'),
    threads = 1,
    log = list(),

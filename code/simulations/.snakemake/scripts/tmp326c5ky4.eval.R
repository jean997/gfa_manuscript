...
snakemake <- Snakemake(
    input = list('../../results/simulation_results/simulate/simulate.B1.3.0.RDS', '../../results/simulation_results/gfa/gfa_ldsc_pval_1e-3.B1.3.0.RDS', "dat" = '../../results/simulation_results/simulate/simulate.B1.3.0.RDS', "fit" = '../../results/simulation_results/gfa/gfa_ldsc_pval_1e-3.B1.3.0.RDS'),
    output = list('../../results/simulation_results/gfa/df_gfa_ldsc_pval_1e-3.B1.3.0.RDS', "out" = '../../results/simulation_results/gfa/df_gfa_ldsc_pval_1e-3.B1.3.0.RDS'),
    params = list(),
    wildcards = list('gfa', 'ldsc_pval_1e-3', 'B1', '3', '0', "method" = 'gfa', "mtype" = 'ldsc_pval_1e-3', "scenario" = 'B1', "ndense" = '3', "rep" = '0'),
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'mem_mib', 'disk_mb', 'disk_mib', 'tmpdir', "mem_mb" = 1995, "mem_mib" = 1903, "disk_mb" = 1995, "disk_mib" = 1903, "tmpdir" = '/tmp'),
    config = list(),
    rule = 'eval',

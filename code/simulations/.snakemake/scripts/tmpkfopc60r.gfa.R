...
snakemake <- Snakemake(
    input = list('../../results/simulation_results/simulate/simulate.B2.12.0.RDS', '../../results/simulation_results/R_ests/R_ests.B2.12.0.RDS', "inp" = '../../results/simulation_results/simulate/simulate.B2.12.0.RDS', "R" = '../../results/simulation_results/R_ests/R_ests.B2.12.0.RDS'),
    output = list('../../results/simulation_results/gfa/gfa_oracle_pval_1.B2.12.0.RDS', "out" = '../../results/simulation_results/gfa/gfa_oracle_pval_1.B2.12.0.RDS'),
    params = list(),
    wildcards = list('oracle', 'pval', '1', 'B2', '12', '0', "Rstring" = 'oracle', "ldtype" = 'pval', "pthresh" = '1', "scenario" = 'B2', "ndense" = '12', "rep" = '0'),
    threads = 1,
    log = list(),

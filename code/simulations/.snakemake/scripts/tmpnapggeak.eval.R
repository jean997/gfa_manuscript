...
snakemake <- Snakemake(
    input = list('../../results/simulation_results/simulate/simulate.A.3.0.RDS', '../../results/simulation_results/svd/svd_0_5e-8.A.3.0.RDS', "dat" = '../../results/simulation_results/simulate/simulate.A.3.0.RDS', "fit" = '../../results/simulation_results/svd/svd_0_5e-8.A.3.0.RDS'),
    output = list('../../results/simulation_results/svd/df_svd_0_5e-8.A.3.0.RDS', "out" = '../../results/simulation_results/svd/df_svd_0_5e-8.A.3.0.RDS'),
    params = list(),
    wildcards = list('svd', '0_5e-8', 'A', '3', '0', "method" = 'svd', "mtype" = '0_5e-8', "scenario" = 'A', "ndense" = '3', "rep" = '0'),
    threads = 1,
    log = list(),

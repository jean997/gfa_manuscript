...
snakemake <- Snakemake(
    input = list('../../results/simulation_results/simulate/simulate.A.0.0.RDS', '../../results/simulation_results/ml/ml_6.A.0.0.RDS', "dat" = '../../results/simulation_results/simulate/simulate.A.0.0.RDS', "fit" = '../../results/simulation_results/ml/ml_6.A.0.0.RDS'),
    output = list('../../results/simulation_results/ml/df_ml_6.A.0.0.RDS', "out" = '../../results/simulation_results/ml/df_ml_6.A.0.0.RDS'),
    params = list(),
    wildcards = list('ml', '6', 'A', '0', '0', "method" = 'ml', "mtype" = '6', "scenario" = 'A', "ndense" = '0', "rep" = '0'),
    threads = 1,
    log = list(),

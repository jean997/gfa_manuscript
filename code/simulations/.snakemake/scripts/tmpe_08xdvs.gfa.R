...
snakemake <- Snakemake(
    input = list('../../results/simulation_results/simulate/simulate.B1.12.0.RDS', '../../results/simulation_results/R_ests/R_ests.B1.12.0.RDS', "inp" = '../../results/simulation_results/simulate/simulate.B1.12.0.RDS', "R" = '../../results/simulation_results/R_ests/R_ests.B1.12.0.RDS'),
    output = list('../../results/simulation_results/gfa/gfa_pt0.05_pval_1.B1.12.0.RDS', "out" = '../../results/simulation_results/gfa/gfa_pt0.05_pval_1.B1.12.0.RDS'),
    params = list(),
    wildcards = list('pt0.05', 'pval', '1', 'B1', '12', '0', "Rstring" = 'pt0.05', "ldtype" = 'pval', "pthresh" = '1', "scenario" = 'B1', "ndense" = '12', "rep" = '0'),
    threads = 1,
    log = list(),

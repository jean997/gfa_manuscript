...
snakemake <- Snakemake(
    ...
    output = list('../../results/simulation_results/ml/ml_6.B2.3.0.RDS', "out" = '../../results/simulation_results/ml/ml_6.B2.3.0.RDS'),
    params = list(),
    wildcards = list('6', 'B2', '3', '0', "nfct" = '6', "scenario" = 'B2', "ndense" = '3', "rep" = '0'),
    threads = 1,
    log = list(),

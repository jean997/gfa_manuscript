...
snakemake <- Snakemake(
    ...
    output = list('../../results/simulation_results/R_ests/R_ests.A.3.0.RDS', "out" = '../../results/simulation_results/R_ests/R_ests.A.3.0.RDS'),
    params = list(),
    wildcards = list('A', '3', '0', "scenario" = 'A', "ndense" = '3', "rep" = '0'),
    threads = 1,
    log = list(),

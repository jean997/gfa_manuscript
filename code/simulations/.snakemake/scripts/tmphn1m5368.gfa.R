...
snakemake <- Snakemake(
    ...
    output = list('../../results/simulation_results/gfa/gfa_ldsc_random_1e-3.B2.3.0.RDS', "out" = '../../results/simulation_results/gfa/gfa_ldsc_random_1e-3.B2.3.0.RDS'),
    params = list(),
    wildcards = list('ldsc', 'random', '1e-3', 'B2', '3', '0', "Rstring" = 'ldsc', "ldtype" = 'random', "pthresh" = '1e-3', "scenario" = 'B2', "ndense" = '3', "rep" = '0'),
    threads = 1,
    log = list(),

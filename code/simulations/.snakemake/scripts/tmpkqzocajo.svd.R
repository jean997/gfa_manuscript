...
snakemake <- Snakemake(
    input = list('../../results/simulation_results/simulate/simulate.A.12.0.RDS', "inp" = '../../results/simulation_results/simulate/simulate.A.12.0.RDS'),
    output = list('../../results/simulation_results/svd/svd_0_5e-8.A.12.0.RDS', "out" = '../../results/simulation_results/svd/svd_0_5e-8.A.12.0.RDS'),
    params = list(),
    wildcards = list('0', '5e-8', 'A', '12', '0', "zero_thresh" = '0', "pthresh" = '5e-8', "scenario" = 'A', "ndense" = '12', "rep" = '0'),
    threads = 1,
    log = list(),

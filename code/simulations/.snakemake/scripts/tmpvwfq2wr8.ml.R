...
snakemake <- Snakemake(
    ...
    output = list('../../results/simulation_results/ml/ml_6.A.12.0.RDS', "out" = '../../results/simulation_results/ml/ml_6.A.12.0.RDS'),
    params = list(),
    wildcards = list('6', 'A', '12', '0', "nfct" = '6', "scenario" = 'A', "ndense" = '12', "rep" = '0'),
    threads = 1,
    log = list(),

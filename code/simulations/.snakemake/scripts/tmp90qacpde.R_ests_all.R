...
snakemake <- Snakemake(
    ...
    output = list('../../results/simulation_results/R_ests/R_ests.A.0.0.RDS', "out" = '../../results/simulation_results/R_ests/R_ests.A.0.0.RDS'),
    params = list(),
    wildcards = list('A', '0', '0', "scenario" = 'A', "ndense" = '0', "rep" = '0'),
    threads = 1,
    log = list(),

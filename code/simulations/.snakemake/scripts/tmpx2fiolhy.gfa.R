...
snakemake <- Snakemake(
    input = list('../../results/simulation_results/simulate/simulate.B3.3.0.RDS', '../../results/simulation_results/R_ests/R_ests.B3.3.0.RDS', "inp" = '../../results/simulation_results/simulate/simulate.B3.3.0.RDS', "R" = '../../results/simulation_results/R_ests/R_ests.B3.3.0.RDS'),
    output = list('../../results/simulation_results/gfa/gfa_pt0.05_random_1e-3.B3.3.0.RDS', "out" = '../../results/simulation_results/gfa/gfa_pt0.05_random_1e-3.B3.3.0.RDS'),
    params = list(),
    wildcards = list('pt0.05', 'random', '1e-3', 'B3', '3', '0', "Rstring" = 'pt0.05', "ldtype" = 'random', "pthresh" = '1e-3', "scenario" = 'B3', "ndense" = '3', "rep" = '0'),
    threads = 1,
    log = list(),

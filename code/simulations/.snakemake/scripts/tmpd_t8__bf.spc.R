...
snakemake <- Snakemake(
    ...
    output = list('../../results/simulation_results/spc/spc_5e-8.A.0.0.RDS', "out" = '../../results/simulation_results/spc/spc_5e-8.A.0.0.RDS'),
    params = list(),
    wildcards = list('5e-8', 'A', '0', '0', "pthresh" = '5e-8', "scenario" = 'A', "ndense" = '0', "rep" = '0'),
    threads = 1,
    log = list(),

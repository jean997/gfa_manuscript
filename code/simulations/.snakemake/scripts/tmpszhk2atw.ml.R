...
snakemake <- Snakemake(
    ...
    output = list('../../results/simulation_results/ml/ml_12.B2.3.0.RDS', "out" = '../../results/simulation_results/ml/ml_12.B2.3.0.RDS'),
    params = list(),
    wildcards = list('12', 'B2', '3', '0', "nfct" = '12', "scenario" = 'B2', "ndense" = '3', "rep" = '0'),
    threads = 1,
    log = list(),

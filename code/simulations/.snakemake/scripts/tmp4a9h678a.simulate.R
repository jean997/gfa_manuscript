...
snakemake <- Snakemake(
    input = list(),
    output = list('../../results/simulation_results/simulate/simulate.B2.3.0.RDS', "out" = '../../results/simulation_results/simulate/simulate.B2.3.0.RDS'),
    params = list(),
    wildcards = list('B2', '3', '0', "scenario" = 'B2', "ndense" = '3', "rep" = '0'),
    threads = 1,
    log = list(),

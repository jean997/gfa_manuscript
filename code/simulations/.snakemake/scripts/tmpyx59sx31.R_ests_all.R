...
snakemake <- Snakemake(
    ...
    output = list('../../results/simulation_results/R_ests/R_ests.B3.12.0.RDS', "out" = '../../results/simulation_results/R_ests/R_ests.B3.12.0.RDS'),
    params = list(),
    wildcards = list('B3', '12', '0', "scenario" = 'B3', "ndense" = '12', "rep" = '0'),
    threads = 1,
    log = list(),

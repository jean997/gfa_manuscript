...
snakemake <- Snakemake(
    input = list('../../results/simulation_results/simulate/simulate.B2.0.0.RDS', '../../results/simulation_results/svd/svd_0_5e-8.B2.0.0.RDS', "dat" = '../../results/simulation_results/simulate/simulate.B2.0.0.RDS', "fit" = '../../results/simulation_results/svd/svd_0_5e-8.B2.0.0.RDS'),
    output = list('../../results/simulation_results/svd/df_svd_0_5e-8.B2.0.0.RDS', "out" = '../../results/simulation_results/svd/df_svd_0_5e-8.B2.0.0.RDS'),
    params = list(),
    wildcards = list('svd', '0_5e-8', 'B2', '0', '0', "method" = 'svd', "mtype" = '0_5e-8', "scenario" = 'B2', "ndense" = '0', "rep" = '0'),
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'mem_mib', 'disk_mb', 'disk_mib', 'tmpdir', "mem_mb" = 1840, "mem_mib" = 1755, "disk_mb" = 1840, "disk_mib" = 1755, "tmpdir" = '/tmp'),
    config = list(),
    rule = 'eval',

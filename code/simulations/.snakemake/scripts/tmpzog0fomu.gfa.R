...
snakemake <- Snakemake(
    ...
    output = list('../../results/simulation_results/gfa/gfa_none_pval_1.A.12.0.RDS', "out" = '../../results/simulation_results/gfa/gfa_none_pval_1.A.12.0.RDS'),
    params = list(),
    wildcards = list('none', 'pval', '1', 'A', '12', '0', "Rstring" = 'none', "ldtype" = 'pval', "pthresh" = '1', "scenario" = 'A', "ndense" = '12', "rep" = '0'),
    threads = 1,
    log = list(),

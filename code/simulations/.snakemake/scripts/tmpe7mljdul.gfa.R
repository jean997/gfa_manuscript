...
snakemake <- Snakemake(
    ...
    output = list('../../results/simulation_results/gfa/gfa_ldsc_pval_1.B3.3.0.RDS', "out" = '../../results/simulation_results/gfa/gfa_ldsc_pval_1.B3.3.0.RDS'),
    params = list(),
    wildcards = list('ldsc', 'pval', '1', 'B3', '3', '0', "Rstring" = 'ldsc', "ldtype" = 'pval', "pthresh" = '1', "scenario" = 'B3', "ndense" = '3', "rep" = '0'),
    threads = 1,
    log = list(),
